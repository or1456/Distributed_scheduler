...
# if 1
        LOG_I(NR_MAC,"==================================== \n");
        LOG_I(NR_MAC,"         NR_UL_DSI_FORMAT(UE 1) \n"); 
        // LOG_I(NR_MAC,"=============  common  ============= \n");
        ...
        int UE1_PRB,UE2_PRB,UE1_BSR,UE2_BSR,GCD_BSR = 0;
        int new_fda = 0;
        float BSR_PRB = 0;
        
        // Set UE1's and UE2's BSR.
        UE1_BSR = dci_pdu_rel15->buffer_size;
        UE2_BSR = ((dci_pdu_rel15->DSI_dedicated)>> 9) & 31;
        ...
        new_fda = (dci_pdu_rel15->frequency_domain_assignment.val/(n_UE*(mwnl_rb_size-1)+(n_UE-1))*(UE1_PRB-1));
        // =========================================
